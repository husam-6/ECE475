...
def create_table(b_hat, tab, skip=0):
...
tab = create_table(b_hat, tab, skip=1)
...
tab = create_table(b_ridge_best, tab)
...
alpha = np.linspace(0.001, 1, 10000)
...
tab = create_table(best_parameters["weights"], tab)
